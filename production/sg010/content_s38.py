...
def apply(d,compact,apps,walk):
    ...
    merge_term(apps,'MCA / maximum OCP','S38: neither value is the disconnect enclosure rating, and neither alone proves the installed circuit is suitable.','cooling_water_air',topics['cooling_water_air']['title'],topics['cooling_water_air']['refs'])
